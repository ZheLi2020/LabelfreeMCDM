...
from echosyn.common.datasets import ImageSet, TensorMotionSet, TensorSet, TensorMotionSpecial
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default='configs/default_test.yaml', help="Path to config file.")
    parser.add_argument("--unet", type=str, default='../../experiments_un/20250829-181238/checkpoint-1000000/unet_ema', help="Path unet checkpoint.")
    parser.add_argument("--motion", type=str,
                        default='/vol/idea_longterm/ot70igyn/EMA-VFI/log/train_EchoNet/20250811-090946/motion_86',
    ...
    parser.add_argument("--output", type=str, default="../../experiments_un/20250829-181238/motion_1000000_64_step128", help="Output directory.")
    ...
    parser.add_argument("--frames", type=int, default=64, help="Number of frames to generate. Must be a multiple of 32",)
    ...
    # 2 - Load models
    print('Load unet model from: ', args.unet)
    print(args)
    ...
    if file_ext == "pt" and args.motion is None:
        ...
        dataset = TensorMotionSet(args.conditioning, args.motion, args.chunk)
        # dataset = TensorMotionSpecial(args.conditioning, args.motion, args.chunk)
    else:
    ...
    with torch.no_grad():
        while not finished:
            for cond in dataloader:
                ...
                cond, motion, latent_name, motion_name = cond
                ...
                forward_kwargs["encoder_hidden_states"] = motion
                ...
                for j in range(B):
                    ...
                    filelist.append([output_name, 0, 0, 0, video.shape[1], video.shape[2],
